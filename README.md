...
- If you do not plan to use the "ShiftlockEnabled" attribute you can set the value of "ShiftlockAttributeListener" which is in ShiftLockController Module to nil or false to disable the feature (THIS WILL BE IN UPDATED VERSION NOT CURRENT!)
